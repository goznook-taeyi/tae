...
class Studio:
    ...
    def _spawn_claude(self, project: str, request: str) -> None:
        ...
        parts = [
            ...
            "편집 판단(주제·Hook 점수화·컷·자막·구성)은 EDITING_AGENT.md"
            "(C-41 Senior Content PD v1.0)를 읽고 그 기준을 따라줘. "
            "특히: 분석 먼저·의미 단위 컷·문장 중간 삭제 금지·의료 표현 변경 "
            "금지·자막 2줄/15자. 끝나기 전 STEP 13 Quality Check를 수행하고 "
            "체크 결과를 로그에 남겨줘.",
